...
<div class="row fullhd ali-center shop-center">
  <div class="container">
    <div class="col-sm-5 fioh blackh">
      ...
      <p><a href="#cata" class="btn btn-fio">Весь каталог</a></p>
    </div>
  </div>
</div>
  ...
  <div class="container">
      ...
      <?php endif; ?>
      <div id="cata" class="fioh">
        <?php print render($page['content']); ?>
      </div>
<!--  <div class="col-sm-4">
      <div class="hidden-sm hidden-md hidden-lg">
        <a href="#" class="btn btn-dark" id="hid-catalog">Каталог</a>
      </div>
      <div id="body-catalog">
        <?php print render($page['sidebar_first']); ?>
        <div class="hidden-sm hidden-md hidden-lg">
        <a href="#" class="btn btn-dark" id="hid-catalog-2">Закрыть</a>
        </div>
      </div>
...
;?>
<?php 
  include('masters.tpl.php');
;?>
<?php 
  include('review-google.tpl.php');
...
;?>
<?php 
  include('slide.tpl.php');
;?>
<?php 
  include('download.tpl.php');
;?>
<?php
  include('map-shop.tpl.php'); 
