  ...
  <div class="container">
    <div class="col-sm-5 fioh sal-block">
        ...
        <div class="col-sm-8 dark-block">
          ...
          <p><a href="#contacts" id="obr-act-3" class="btn btn-lg btn-primary">Подобрать курс</a></p>
...
<div class="row">
  <div class="container">
      ...
      <?php endif; ?>
      <div class="row fioh" id="course">
        <div class="col-sm-5 pad-0">
          <h2 class="block-title">Наши учебные программы</h2>
        </div>
      </div>
