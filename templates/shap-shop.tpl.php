...
<?php if ($logo): ?>
    ...
    <div class="col-sm-6 col-md-5">
      <div class="sh-contacts">
        <div class="col-xs-6 active razd">
      ...
      <div class="navbar-collapse collapse" id="navbar-collapse">
        <nav role="navigation">
          ...
          <div class="so-link pull-right">
            <div class="so-but"><a href="https://vk.com/hairshopminsk"><div class="vk"></div></a></div>
            <div class="so-but"><a href="https://www.instagram.com/hairshop.by/"><div class="insta"></div></a></div>
          </div>
          </div>    
...
<?php endif; ?>
 ...
 <?php print render($page['cart_num']); ?>

<div class="hidden-sm hidden-md hidden-lg">
  <div class="row xs-bot-menu">
    <div class="closer" id="close-catalog">Закрыть</div>
    <div class="col-xs-6 xs-bot"><a href="#" class="" id="hide-catalog"><div class="xs-bot-left">Каталог</div></a></div>
    <div class="col-xs-6 xs-bot"><a href="/cart" class=""><div class="xs-bot-right">Корзина</div></a></div>
  </div>
  <div class="row fix-cata" id="body-cata">
